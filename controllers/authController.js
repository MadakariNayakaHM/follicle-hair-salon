...
exports.removeUser= async (req,res)=>
{
  try{
    ...
    {
     res.status(200).json({status:"fail", message:"user not exixt"});
    }
  }catch(e){
    console.log("error at remove user")
    console.log(e);
  }
}
exports.addWorker= async (req,res)=>
{
  try{
    ...
    if(user)
    {
     await User.findByIdAndUpdate(user._id,{roles:req.body.roles},{ new: true, runValidators: true })
    }
    else
    {
     res.status(200).json({status:"fail", message:"user not exixt"});
    ...
    console.log("error at adding worker")
    console.log(e);
  }
}
...
exports.addService=async(req,res)=>
{
 ...
 {
  console.log(e);
  console.log("erroe at add services");
 }
}